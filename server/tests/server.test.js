...
describe('PATCH /todos:id', () => {
    ...
    it('should return 404 if creator is not the creator of the todo being updated', (done) => {
        var testCompleted = {
            text: 'Second test todo UPDATED', 
            completed: true
        }; 
        ...
        request(app)
            ...
            .end((err, res) => {
                ...
                Todo.findById(todos[0]._id.toHexString()).then((todo) => {
                    expect(todo.text).toNotBe(testCompleted.text);
...
describe('DELETE /users/me/token', () => {
    it('should delete token if it exists', (done) => {
        request(app)
